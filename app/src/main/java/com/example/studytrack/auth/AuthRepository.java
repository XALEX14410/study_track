...
import com.example.studytrack.utils.CacheUtils;
import com.example.studytrack.utils.NetworkUtils;
...
public class AuthRepository {
    ...
    public boolean hasActiveSession() {
        ...
        if (sessionManager.isLoggedIn() && !NetworkUtils.isNetworkAvailable(appContext)) {
            AppLogger.logInfo(TAG, "Using secure offline session cache");
            return true;
        }
